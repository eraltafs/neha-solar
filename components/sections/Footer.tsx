    ...
    <footer className="bg-slate-950 text-slate-300">
        ...
        <div className="grid gap-14 lg:grid-cols-4">
          ...
          <div>
            <Link href="/" className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-2xl font-bold text-white">Neha Solar</h3>

                <p className="text-sm text-green-500">Suppliers</p>
              </div>
            </Link>
          ...
          <div>
            ...
            <div className="space-y-4">
              {[
                ...
                <p key={item} className="transition hover:text-green-500">
                  {item}
                </p>
              ))}
            </div>
          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                <Phone size={22} className="mt-1 text-green-500" />
              ...
              <div className="flex items-start gap-4">
                <Mail size={22} className="mt-1 text-green-500" />
              ...
              <div className="flex items-start gap-4">
                <MapPin size={22} className="mt-1 text-green-500" />
      ...
      <div className="border-t border-slate-800">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 px-6 py-6 text-sm text-slate-500 md:flex-row">
          <p>
            © {new Date().getFullYear()} Neha Solar Suppliers. All Rights
            Reserved.
          </p>

          <p>
            Designed & Developed by{" "}
            <span className="font-semibold text-green-500">Eraltafs</span>
          </p>
        </div>
      </div>
    </footer>
